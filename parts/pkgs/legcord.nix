...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    owner = "Legcord";
    repo = "Legcord";
    rev = "5c4e9d0707dca9cfde324b83a6423497a251e6c4";
    hash = "sha256-DgR5lF2jYtbhFVKONrcHC4c8oEg5QlARLNIzc59rPTQ=";
  };
  ...
  pnpmDeps = fetchPnpmDeps {
    ...
    pnpm = pnpm_10_29_2;
    fetcherVersion = 3;
    hash = "sha256-kE3EeRfV2iGH0F+a/uWX3qWgHdBWxIhW+59wwkCSZRc=";
  };
